        ...
        <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
            ...
            <motion.header
             ...
             border border-white/10 px-8 py-6 shadow-[0_20px_45px_rgba(0,0,0,0.6)]'>
                ...
                <h1 className='text-2xl font-bold
                 bg-linear-to-r from-white via-gray-300
                  to-white bg-clip-text text-transparent'>ExamNotes</h1>
                <p className='text-sm text-gray-300 mt-1'>AI-powered exam-oriented notes & revision</p>

            </motion.header>

            <main className='max-w-7xl mx-auto py-10 grid grid-cols-1 
            lg:grid-cols-2 gap-20 items-center'>
                ...
                >
                    ...
                    <p className='mt-4 text-sm text-gray-500'>Start with 50 free credits
                        Upgrade anytime for more credits Instant access</p>

                </motion.div>

                {/*RIGHT CONTENT*/}
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
                    <Feature icon="🎁" title="50 credits" des="Start with 50 credits to generate notes without paying" />
                    <Feature icon="📗" title="Exam Notes" des="High-yeild revision-ready exam oriented notes" />
                    <Feature icon="📂" title="Project Notes" des="Well-structured documentation for assignment & project"/>
                    <Feature icon="📊" title="Charts & Graphs" des="Auto-generated diagrams, charts and flow graphs"/>
                    <Feature icon="⬇️" title="Free PDF Downlaod" des="Download clean , peintable PDFs instantly" />
                </div>
